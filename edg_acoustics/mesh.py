"""This module, based on the `meshio <https://github.com/nschloe/meshio>`_ package, provide functions and classes provide functionality to process
...
class Mesh:
    ...
    Attributes:
        ...
        filename (str): the file (pathlike) to read mesh data from. Current supported format includes
