...
def dg_method(json_file_path=None):
    ...
    mesh_name = "/Users/SilvinW/repositories/ra_ui_backend/edg-acoustics/examples/scenario1/scenario1_coarser.msh"  # name of the mesh file. The mesh file should be in the same folder as this script.
    ...
    for material, label in BC_labels.items():
        if material == "hard wall":
            ...
            mat_files = glob.glob(f"{os.path.split(os.path.abspath(__file__))[0]}/../examples/scenario1/{material}*.mat")
